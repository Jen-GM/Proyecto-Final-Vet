                ...
                <div className="carousel-item active">
                  ...
                  <div className="carousel-caption d-none d-md-block bg-dark text-white p-2">
                    ...
                    <p className="fs-5">
                      ...
                      médico veterinario como el cliente humano encontrará la
                      información en el mismo lugar. Un software fácil y
                      sencillo de utilizar pensado en facilitar la comunicación
                      médico/cliente.
                    </p>
                  </div>
                </div>
                <div className="carousel-item">
                  ...
                  <div className="carousel-caption d-none d-md-block bg-light text-dark p-2">
                    ...
                    <p className="fs-5">
                      ...
                      tenés la tarjeta con su información a mano? Peor aún, se
                      te pierden siempre sus tarjetas de vacunas. ¡No te
                      preocupés! Con <strong>PetSource</strong> todo lo tenés en
                      el mismo lugar. Sus atenciones médicas, las
                      desparacitaciones y las vacunas las encontrarás en su
                      expediente con tan solo ingresar a nuestra página.
                    </p>
                  </div>
                </div>
                <div className="carousel-item">
                  ...
                  <div className="carousel-caption d-none d-md-block bg-dark text-white p-2">
                    ...
                    <p className="fs-5">
                      ...
                      Se te brindará la opción de sacar la cita para la hora y
                      día que mejor se acomode a tus necesidades sin necesidad
                      de que tengás que contactar directamente a la veterinaria.
                    </p>
                  </div>
                </div>
              </div>
